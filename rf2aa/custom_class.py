...
class ModelManager:
    ...
    def __init__(self, device, checkpoint_path, template_db, sequencedb_ur30, sequencedb_bfd) -> None:
        self.config = self.load_config(sequencedb_ur30, sequencedb_bfd, template_db)
    ...
    @staticmethod
    def load_config(sequencedb_ur30, sequencedb_bfd, template_db):
        ...
        with initialize(config_path=config_path):
            ...
            cfg = compose(
                config_name="base")
        with open_dict(cfg):
            cfg.database_params.sequencedb_ur30 = sequencedb_ur30
            cfg.database_params.sequencedb_bfd = sequencedb_bfd
            cfg.database_params.hhdb = template_db
        return cfg
